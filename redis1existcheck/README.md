...
* *RedisDB* - <a href="http://redis.io/download">Download</a> and Install redis DB - <a href="http://redis.io/documentation">Checkout their manual</a> if you're just starting.
...
### Windows
* *Node.js* - <a href="http://nodejs.org/download/">Download</a> and Install Node.js, nodeschool has free <a href=" http://nodeschool.io/#workshoppers">node tutorials</a> to get you started.
* *RedisDB* - Follow the great tutorial from the redis DB site - <a href="https://redislabs.com/ebook/redis-in-action/appendix-a/a3-installing-on-windows/a3-2-installing-redis-on-window">Install Redis DB On Windows</a>


### OSX
* *Node.js* -  <a href="http://nodejs.org/download/">Download</a> and Install Node.js or use the packages within brew or macports.
* *RedisDB* - Follow the tutorial here - <a href="https://redislabs.com/ebook/redis-in-action/appendix-a/a2-installing-on-os-x">Install Redis DB on OSX</a>
...
Redis is an open source, BSD licensed, advanced key-value store. It is often referred to as a data structure server since keys can contain strings, hashes, lists, sets and sorted sets. The essence of a key-value store is the ability to store some data, called a value, inside a key. This data can later be retrieved only if we know the exact key used to store it. The sample app provided performs basic CRUD operations, for managing data in a simple "To Do" app.


#### Files related to RedisDB

The crux of the DB operations are present in the DBHandler file, present in the controllers directory. The database connection establishment and the CRUD operations are given in this file. The **redis** node module is used to connect to the database.
...
The Application can be run locally or deployed in cloud foundry and in both scenarios RedisDB service has to be integrated with the application.
...
`  "service_name":"redis-cloud", `  // The service instance name created in cloud foundry
...
##### Creating Redis DB service

 IBM Bluemix & Pivotal Web Services offer a free Redis Labs service.
  - If you are using IBM Bluemix or Pivotal Web Services, run
```sh
$ cf create-service RedisCloud 30mb service_instance_name
